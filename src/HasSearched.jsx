      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-20">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="relative p-6 rounded-full bg-blue-500/10 border border-blue-500/30">
              <RotateCw className="w-16 h-16 text-blue-400" />
            </div>
          </div>

          {/* Message */}
          <div className="text-center space-y-2">
            <h2 className="text-white text-3xl font-bold">Search for a city</h2>
            <p className="text-white/60 text-lg">
              Enter a city name to get the current weather 🌤️
            </p>
          </div>
